...
public class findcenter extends AppCompatActivity {
    ...
    {
        Uri gmmIntentUri = Uri.parse("geo:0,0?q=ExpoCenter,Lahore");
    ...
    {
        Uri gmmIntentUri = Uri.parse("geo:0,0?q=North Karachi,Hospital");
        Intent mapIntent = new Intent(Intent.ACTION_VIEW, gmmIntentUri);
        mapIntent.setPackage("com.google.android.apps.maps");
        startActivity(mapIntent);
    }
    ...
    {
        Uri gmmIntentUri = Uri.parse("geo:0,0?q=Bolan Medical Complex Hospital");
        Intent mapIntent = new Intent(Intent.ACTION_VIEW, gmmIntentUri);
        mapIntent.setPackage("com.google.android.apps.maps");
        startActivity(mapIntent);
    }
    ...
    {
        Uri gmmIntentUri = Uri.parse("geo:0,0?q=Khanspur Hospital KPK");
        Intent mapIntent = new Intent(Intent.ACTION_VIEW, gmmIntentUri);
        mapIntent.setPackage("com.google.android.apps.maps");
        startActivity(mapIntent);
    }
