...
public class patient_report extends AppCompatActivity {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot snapshot: dataSnapshot.getChildren()) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Post").
                                    child(key);
                            name =name+ snapshot.child("first_Name").getValue(String.class);
                            contact = contact+ snapshot.child("contact").getValue(String.class);
                            age = age+ snapshot.child("age").getValue(String.class);
                            covid = covid + snapshot.child("covid").getValue(String.class);
                            bp =bp + snapshot.child("blood_Pressure").getValue(String.class);
                            diabetes =diabetes + snapshot.child("diabetes").getValue(String.class);
                        }
                        p_name.setText(name);
                        p_covid.setText(bp);
                        p_age.setText(age);
    ...
    public void backStat(View v)
    {
        Intent intent = new Intent (patient_report.this,MainActivity.class);
